...
package ru.yandex.payment.client;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    public ApiClient(String paymentServiceName, int paymentServicePort) {
        this.basePath = "http://" + paymentServiceName + ":" + paymentServicePort;
